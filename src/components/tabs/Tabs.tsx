          ...
          {tabsData.map(tab => (
            <RadixTabs.Trigger
              className={cn(
                ...
                {
                  'border-dark-100 text-dark-100 data-[state=active]:border-b-2 data-[state=active]:border-blue-500 data-[state=active]:text-accent-500 hover:border-b-2 hover:border-dark-100 hover:bg-accent-900/25 hover:text-dark-100 focus:ring-accent-500 active:bg-accent-100/25':
                    !tab.disabled,
